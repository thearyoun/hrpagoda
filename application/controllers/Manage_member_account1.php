...
class Manage_member_account extends CI_Controller {
	...
	public function index() {
		...
		$data['members'] = $this -> Globals -> select_join_get_only_fields('members', $arr_fields = array('members.*','houses.name as house_name'),$arr_join = array('houses'=>array('use_house_id'=>'id')), $join_type = 'INNER', $arr_where = array('members.id'=>$member_id), $limit = 1,$sort=NULL)->row();
