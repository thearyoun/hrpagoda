							...
							<div class="row">
								<div class="col-sm-6">
									<div class="widget-main no-padding">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="username" name="username" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->username;?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="nation" name="nation" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->nation;?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<div class="input-group">
													<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" name="date_of_birth" class="col-xs-10 col-sm-9" value="<?php echo date("d-m-Y", strtotime($member->row()->date_of_birth));?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<div class="input-group">
													<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" name="stay_date" class="col-xs-10 col-sm-9" value="<?php echo date("d-m-Y", strtotime($member->row()->stay_date));?>"/>
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="education" name="education" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->education;?>"/>
										...
										<div class="form-group">
											...
											<select id="department" name="family_status"class="col-xs-10 col-sm-9">
													...
													<option value="single" <?php echo ($member->row()->family_status == 'single')? 'selected':'';?>>Single</option>
													<option value="married" <?php echo ($member->row()->family_status == 'married')? 'selected':'';?>>Married</option>
												</select>
											</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select id="gender" name="gender" class="col-xs-10 col-sm-9">
												...
												<option value="M" <?php echo ($member->row()->gender == 'M')? 'selected':'';?>>Male</option>
												<option value="F" <?php echo ($member->row()->gender == 'F')? 'selected':'';?>>Female</option>
											</select>
									...
									<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="nationality" name="nationality" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->nationality;?>"/>
									...
									<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="place_of_birth" name="place_of_birth" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->place_of_birth;?>"/>
									...
									<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="current_address" name="current_address" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->current_address;?>"/>
									...
									<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="phone_number" name="phone_number" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->phone_number;?>"/>
									...
									<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="identify_card" name="identify_card" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->identify_card;?>"/>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="widget-main no-padding">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="father_name" name="father_name" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->father_name;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="father_phone" name="father_phone" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->father_phone;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="mother_name" name="mother_name" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->mother_name;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="mother_phone" name="mother_phone" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->mother_phone;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-7">
														<select class="chosen-select form-control" id="monk_response_id" data-placeholder="Choose a monk..." name="monk_response_id">
															...
															?>
															<option value="<?php echo $row->id;?>" <?php echo ($member->row()->monk_response_id == $row->id)? 'selected':'';?>><?php echo $row->username;?></option>
															<?php
																}
															?>
														</select>
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="father_occupation" name="father_occupation" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->father_occupation;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="father_address" name="father_address" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->father_address;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="mother_occupation" name="mother_occupation" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->mother_occupation;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="mother_address" name="mother_address" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->mother_address;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="file" id="photo" name="photo" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('photo'); ?>"/>
										...
										<div class="col-sm-6">
											<div class="widget-main no-padding">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="position" name="position" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo $member->row()->position;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="study_at" name="study_at" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo $member->row()->study_at;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="generation" name="generation" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo $member->row()->generation;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="school_address" name="school_address" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->school_address;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="company_name" name="company_name" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->company_name;?>"/>
											...
											<div class="form-group">
													...
													<div class="col-sm-8">
														<select id="student_type" name="student_type"class="col-xs-10 col-sm-9">
															...
															<option value="1" <?php echo ($member->row()->student_type == 1)? 'selected':'';?>>សិស្ស</option>
															<option value="2" <?php echo ($member->row()->student_type == 2)? 'selected':'';?>>និស្សិត</option>
														</select>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="year" name="year" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo $member->row()->year;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="group" name="group" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo $member->row()->group;?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select id="work_type" name="work_type"class="col-xs-10 col-sm-9">
															...
															<option value="1" <?php echo ($member->row()->work_type == 1)? 'selected':'';?>>បុគ្គលិក</option>
															<option value="2" <?php echo ($member->row()->work_type == 2)? 'selected':'';?>>មន្ត្រីរាជការ</option>
														</select>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="company_address" name="company_address" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo $member->row()->company_address;?>"/>
