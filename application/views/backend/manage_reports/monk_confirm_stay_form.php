...
<div class="row" id="members">
    <div class="col-xs-12">
        <p id="photo" style="width:120px; height:120px; border:1px solid #685353; float:right; margin-right:30%; margin-bottom:3%;"></p>
        <div class="col-xs-12">
            <p class=MsoNormal align=center style='margin-bottom:0;text-align:center;line-height:normal;font-weight: bold'>
            <span lang=KHM style='font-size:13.0pt'>សម្តេចព្រះមហាអរិយវង្ស ព្រះចៅអធិការវត្តលង្កាព្រះកុសុមារាម<br/>
		    បញ្ជាក់ថា</span></p><br/>
            ...
            <table id="tbl-doc">
                ...
                <tr>
                    ...
                    <td style="padding:0px 20px 0px 20px;">:</td>
                    <td>
                        <span><?php echo $monk_info->row()->monk_number; ?></span>
                        <span> ចេញដោយ   </span>
    ...
    .0001pt;text-align:right;line-height:normal; margin-top:2em; margin-right:5em;'>
            <span lang=KHM
                  style='font-size:12.0pt'>វត្តលង្កា ថ្ងៃទី&nbsp;&nbsp;&nbsp;ខែ&nbsp;&nbsp;&nbsp;ឆ្នាំ ២០១៦<br/>
            <span style="padding-right: 10% !important;">ចៅអធិការ </span></p>
