<div class="row" id="members">
    ...
    <p class=MsoNormal align=left style='margin-bottom:0;text-align:center;line-height:normal;font-weight: bold'><span lang=KHM style='font-size:13.0pt;font-family:"Khmer OS Battambang"'>បញ្ជីស្រង់វត្តមាន</span></p>
    ...
    <br />
		<table id="sample-table-0" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th class="center">#</th>
					<th><?php echo $this->lang->line('');?>ឈ្មោះ</th>
