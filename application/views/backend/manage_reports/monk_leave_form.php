<div class="row" id="members"> 
    ...
    style='font-size:12.0pt;font-family:"Khmer OS Battambang"'>
		...
		-ពុទ្ធិកយុវជនឈ្មោះ <span style="padding: 0px 8%;"><?php echo $monk_info->row()->username;?><span> <span style="padding: 0px 8%;">អាយុ ២៩<span>	<span style="padding: 0px 4%;">ជនជាតិ</span>		<?php echo $monk_info->row()->nation;?>		<span style="padding: 0 0 0 4%;">សញ្ជាតិ	</span>	<?php echo $monk_info->row()->nationality;?> </span><br />
		-ថ្ងៃ ខែ ឆ្នាំកំណើត<span style="padding: 0px 10%;">		<?php echo $monk_info->row()->date_of_birth;?></span>	<br />
		...
		-ឆាយាលេខ<span style="padding: 0 0 0 10%;">	<?php echo '៤៣/០៨  ចេញដោយ ព្រះមេគណខេត្តតាកែវ';?></span>	<br />
