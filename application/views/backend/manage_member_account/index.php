...
<table class="table table-striped table-bordered table-hover">
	...
	<tr>
		...
		<th width="20%">ឆ្នាំទី</th>
		<th width="2%">:</th>
		<td width="28%"><?php echo $members->year;?></td>
	</tr>
	<tr>
		<th width="20%">ជំនាន់ទី </th>
		<th width="2%">:</th>
		<td width="28%"><?php echo $members->generation;?></td>
		<th width="20%">ក្រុមទី </th>
		<th width="2%">:</th>
		<td width="28%"><?php echo $members->group;?></td>
	</tr>
	<tr>
		...
		<th width="2%">:</th>
		<td width="28%"><?php echo ($members->work_type == 1)? "មន្រ្ដីរាជការ":"បុគ្គលិក";?></td>
	</tr>
	<tr>
