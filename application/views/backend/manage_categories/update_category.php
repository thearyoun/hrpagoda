<?php
	if($category_data->num_rows()==1){
		$category_id=$category_data->row()->category_id;
		$name=$category_data->row()->name;
		$description=$category_data->row()->description;
		$status=$category_data->row()->status;
...
<div class="row">
	<div class="col-xs-12">
		...
		?>
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_categories/update_category/<?php echo $category_id;?>">
