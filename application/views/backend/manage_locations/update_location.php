<?php
	if($location_data->num_rows()==1){
		$id=$location_data->row()->id;
		$name=$location_data->row()->name;
		$description=$location_data->row()->description;
		$status=$location_data->row()->status;
...
<div class="row">
	<div class="col-xs-12">
		...
		?>
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_locations/update_location/<?php echo $id;?>">
