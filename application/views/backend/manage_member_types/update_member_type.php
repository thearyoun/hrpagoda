<?php
	if($member_type_data->num_rows()==1){
		$id=$member_type_data->row()->id;
		$name=$member_type_data->row()->name;
		$description=$member_type_data->row()->description;
		$status=$member_type_data->row()->status;
...
<!--<div class="page-header">
	<h1> Form member_type <small> <i class="ace-icon fa fa-angle-double-right"></i> Common form create </small></h1>
</div>--><!-- /.page-header -->
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		...
		?>
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_member_types/update_member_type/<?php echo $id;?>">
