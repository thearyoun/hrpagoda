...
<a href="<?php echo base_url();?>manage_lines" class="btn btn-primary btn-sm">
...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_lines/update_line/<?php echo $id;?>">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="description">ពណ័នា:</label>

				<div class="col-sm-9">
					<input type="text" id="description" name="description" placeholder="ពណ័នា" class="col-xs-10 col-sm-5" value="<?php echo $description;?>"/>
					<?php echo form_error('description'); ?>
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="status">ស្ថាមភាព:</label>
