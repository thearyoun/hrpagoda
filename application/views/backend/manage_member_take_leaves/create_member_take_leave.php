<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_member_take_leaves/create_member_take_leave">
	<div class="row">
		<div class="col-sm-12">
			<?php
											...
											<div class="col-sm-7">
											  ...
											  <?php endif;?>
												...
												<select class="chosen-select form-control" id="use_member_id" data-placeholder="សូមជ្រើសរើស..." name="use_member_id">
													...
													?>
													<option value="<?php echo $row->id;?>" <?php echo set_select('use_member_id', $row -> id); ?>><?php echo $row->username;?></option>
													<?php
														}
													?>
												</select>
