...
<label for="">
    ...
    <a href="<?php echo base_url().'manage_users/create_user'?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> បង្កើតថ្មី</a>
</label>
<br/>
<br/>
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_users/update_user/<?php echo $user_id;?>">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="phone">េខទូរស័ព្ទ:<span class="required">*</span></label>
