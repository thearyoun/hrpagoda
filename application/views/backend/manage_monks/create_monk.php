<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_monks/create_monk" enctype="multipart/form-data">
	<div class="row">
		<div class="col-sm-12">
			<?php
					...
					<div class="widget-main">
						<div class="widget-body">
							<div class="row">
								<div class="col-sm-6">
									<div class="widget-main no-padding">
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="username"> ឈ្មោះ :<span class="required">*</span></label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="nick_name"> នាមបញ្ញត្តិ :<span class="required">*</span></label>
											<div class="col-sm-8">
												<input type="text" id="nick_name" name="nick_name" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('nick_name'); ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<div class="input-group">
													<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" name="vegetarian_date" class="col-xs-10 col-sm-9" value="<?php echo set_value('vegetarian_date'); ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="vegetarian_year" name="vegetarian_year" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('vegetarian_year'); ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select class="chosen-select" id="vegetarian_types" data-placeholder="ជ្រើសរើសប្រភេទ..." name="vegetarian_types">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="monk_number" name="monk_number" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo set_value('monk_number'); ?>"/>
												<?php echo form_error('monk_number'); ?>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="user_account"> ឈ្មោះគណនី:<span class="required">*</span></label>
											<div class="col-sm-8">
												<input type="text" id="user_account" name="user_account" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo set_value('user_account'); ?>"/>
												<?php echo form_error('user_account'); ?>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="job"> ការងារបច្ចុប្បន្ន:<span class="required">*</span></label>
											<div class="col-sm-7">
												<select name="jop" id="job" class="col-xs-10 col-sm-9 chosen-select">
													<option value="">--ប្រភេទការងារ--</option>
													<?php
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="eng_name"> ឈ្មោះជាអក្សរឡាតាំង :<span class="required">*</span></label>
									...
									<div class="form-group">
											...
											<div class="col-sm-7">
												<select class="chosen-select form-control" id="use_position_id" data-placeholder="ជ្រើសរើសមុខងារ..." name="use_position_id">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="vegetarian_place" name="vegetarian_place" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('vegetarian_place'); ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select class="chosen-select form-control" id="use_location_id" data-placeholder="ជ្រើសរើសខេត្ត..." name="use_location_id">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" id="acknow_by" name="acknow_by" placeholder="" class="col-xs-10 col-sm-9"  value="<?php echo set_value('acknow_by'); ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select class="chosen-select form-control" id="use_house_id" data-placeholder="ជ្រើសរើសកុដិ..." name="use_house_id">
													<option value="">  </option>
													<?php
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												...
												<div style="margin-top: 6px;">
													<input type="checkbox" name="maser" value="1" id="maser"><label for="maser">ប្រធានក្រុម</label>
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="user_password"> លេខកូដសម្ងាត់ :<span class="required">*</span></label>
											<div class="col-sm-8">
		...
		<div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active">
						<a data-toggle="tab" href="#monk_reference"> <i class="green ace-icon fa fa-home bigger-120"></i> ព័ត៌មានព្រះឧបជ្ឈាយ៍ </a>
					</li>
				</ul>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="widget-main no-padding">
												...
												<label class="col-sm-4 control-label no-padding-right" for="monk_reference"> ព្រះឧបជ្ឈាយ៍នាម :<span class="required">*</span></label>
													<div class="col-sm-8">
														<input type="text" id="monk_reference" name="monk_reference" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('monk_reference'); ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="monk_reference_position" name="monk_reference_position" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('monk_reference_position'); ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<textarea id="monk_current_address" name="monk_current_address" placeholder="" class="col-xs-10 col-sm-9">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" id="monk_reference_phone" name="monk_reference_phone" placeholder="" class="col-xs-10 col-sm-9" value="<?php echo set_value('monk_reference_phone'); ?>"/>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active">
						<a data-toggle="tab" href="#home"> <i class="green ace-icon fa fa-home bigger-120"></i> ព័ត៌មានគ្រួសាររបស់ព្រះសង្ឃ </a>
					</li>
				</ul>
				<div class="tab-content">
					<div id="home" class="tab-pane fade in active">
										...
										<div class="col-sm-6">
											<div class="widget-main no-padding">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="from_pagoda" name="from_pagoda" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo set_value('from_pagoda'); ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="number_of_bro_sis" name="number_of_bro_sis" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo set_value('number_of_bro_sis'); ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="number_of_sister" name="number_of_sister" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo set_value('number_of_sister'); ?>"/>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="number_of_brother" name="number_of_brother" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo set_value('number_of_brother'); ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="child_level" name="child_level" placeholder="" class="col-xs-10 col-sm-9" required="required" value="<?php echo set_value('child_level'); ?>"/>
