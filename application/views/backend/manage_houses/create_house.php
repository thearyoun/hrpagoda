<!--<div class="page-header">
	<h1> Form house <small> <i class="ace-icon fa fa-angle-double-right"></i> Common form create </small></h1>
</div>--><!-- /.page-header -->
...
<div class="row">
	<div class="col-xs-12">
		...
		?>
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_houses/create_house">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="name">ឈ្មោះកុដិ:<span class="required">*</span></label>

				<div class="col-sm-9">
					<input type="text" id="name" name="name" placeholder="ឈ្មោះកុដិ" class="col-xs-10 col-sm-5" required="required" />
