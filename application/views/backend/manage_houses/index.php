						...
						<tr>
							...
							<td>
								...
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a class="green" href="<?php echo base_url();?>manage_houses/update_house/<?php echo $row->id;?>" title="កែប្រែ"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
					
									<a class="red" href="<?php echo base_url();?>manage_houses/លុប_house/<?php echo $row->id;?>" title="លុប" onclick="return confirm('Are you sure want to លុប this selected house ?')"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a>
								</div>
								<div class="hidden-md hidden-lg">
									<div class="inline house-relative">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											...
											<li>
												<a href="<?php echo base_url();?>houses/update_house/<?php echo $row->id;?>" class="tooltip-success" data-rel="tooltip" title="កែប្រែ"> <span class="green"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </span> </a>
											</li>
					
											<li>
												<a href="<?php echo base_url();?>houses/លុប_house/<?php echo $row->id;?>" class="tooltip-error" data-rel="tooltip" title="លុប"> <span class="red"> <i class="ace-icon fa fa-trash-o bigger-120"></i> </span> </a>
											</li>
										</ul>
									</div>
								</div>
