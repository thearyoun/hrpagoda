...
?>
<a href="<?php echo base_url();?>manage_departments"​ class="btn btn-primary btn-sm">
...
<div class="row">
	<div class="col-xs-12">
		...
		?>
		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>manage_departments/update_department/<?php echo $id;?>">
