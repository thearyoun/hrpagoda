...
workingday.type_job");
    ...
    {
        $query = "select use_monk_id as MDI,use_handle_by_id,use_leave_type_id,from_date,to_date,reason,notes,request_date,monk_take_leaves.status,'monk' as type,photo,username, monk_take_leaves.created_at
